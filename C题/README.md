...
│   └── a2a-usage-examples.md        # Agent通信示例
│
...
│
├── MCMICM E题/                      # E题参考资料
└── other's MathModelAgent/          # 参考项目
```

> ⚠️ **运行提示**: Python脚本需在 `C题/` 目录下运行
> ```bash
> cd C题
> python src/main.py
> ```
